...
//         /* Single breakpoint that handles all mobile/tablet layouts */
...
//         /* Posts grid: never overflow, always fill available width */
//         .posts-grid {
//           display: grid;
...
//         /* Prevent hero content from causing horizontal scroll on mobile */
...
//         <div style={{ background: 'linear-gradient(135deg,#0f1a12 0%,#14532d 60%,#166534 100%)', padding: '48px 24px 80px', position: 'relative', overflow: 'hidden', width: '100%' }}>
//           <div style={{ position: 'absolute', top: '-30%', right: '-5%', width: 600, height: 600, borderRadius: '50%', background: 'rgba(74,222,128,.05)', pointerEvents: 'none' }} />
//           <div style={{ maxWidth: 1280, margin: '0 auto', position: 'relative', zIndex: 1, width: '100%' }}>
//             <div className="two-col hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'center' }}>
//               <div>
...
//                 </span>
//                 <h1 style={{ fontFamily: "'Playfair Display',serif", fontSize: 'clamp(28px,5vw,52px)', fontWeight: 800, color: 'white', marginBottom: 20, lineHeight: 1.2 }}>
//                   {featuredPost.title}
//                 </h1>
...
//               </div>
//               {featuredPost.image && (
//                 <div className="hero-image" style={{ borderRadius: 24, overflow: 'hidden', boxShadow: '0 20px 60px rgba(0,0,0,.3)', border: '1px solid rgba(255,255,255,.1)', height: 360 }}>
...
//       {/* ── Category Banner ── */}
//       {category && (
//         <div style={{ background: 'linear-gradient(135deg,#0f1a12 0%,#14532d 100%)', padding: '36px 24px 40px', width: '100%' }}>
...
//       <div style={{ maxWidth: 1280, margin: featuredPost && !searchQuery && !category ? '-52px auto 0' : '0 auto', padding: '0 16px 48px', position: 'relative', zIndex: 1, width: '100%' }}>
...
//             {/* Filter Tabs */}
//             <div style={{ display: 'flex', gap: 0, borderBottom: `2px solid ${c.filterBorder}`, marginBottom: 32, overflowX: 'auto', WebkitOverflowScrolling: 'touch' }}>
//               {[
...
//           {/* ── Sidebar ── */}
//           <div style={{ animation: 'fadeUp .4s ease .12s both', minWidth: 0 }}>
...
const BreakingNewsTicker = ({ posts, isDark }) => {
  const headlines = useMemo(() =>
    posts.slice(0, 10).map(p => p.title).filter(Boolean),
    [posts]
  );
...
const Home = () => {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans',sans-serif", background: c.pageBg, minHeight: '100vh', transition: 'background .3s', overflowX: 'hidden', width: '100%', boxSizing: 'border-box' }}>
      ...
      {/* ── Breaking News Ticker ── */}
      <BreakingNewsTicker posts={posts.length ? posts : trendingPosts} isDark={isDark} />
      ...
      <div style={{
        ...
        <div className="two-col" style={{ display:'grid', gridTemplateColumns:'2fr 1fr', gap:32, width:'100%' }}>
          ...
          <div style={{ animation:'fadeUp .4s ease .05s both', minWidth:0 }}>
            ...
            {/* Section header when viewing all news */}
            {!category && !searchQuery && (
              <SectionHeader
                eyebrow="Latest Coverage"
                title="Today's Top Stories"
                sub="Stay informed with the most important news from around the world"
                left
              />
            )}
          ...
          <div style={{ animation:'fadeUp .4s ease .15s both', minWidth:0 }}>
            ...
            {/* Trending Now */}
            <div style={{ background:c.cardBg, borderRadius:24, padding:'28px 24px', boxShadow:'0 4px 24px rgba(0,0,0,.07)', border:`1px solid ${c.cardBorder}`, marginBottom:24, position:'sticky', top:88 }}>
              <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:20 }}>
