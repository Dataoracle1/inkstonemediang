...
const NewsDetail = () => {
  ...
  return (
    <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
      ...
      <Link
        to="/"
        className="inline-flex items-center space-x-2 text-primary-500 hover:text-primary-600 mb-4 sm:mb-6 transition touch-manipulation"
      >
        <ArrowLeft size={20} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
        ...
        <div className="lg:col-span-2">
          <article className="card p-4 sm:p-6 lg:p-8">
            {/* Category Badge */}
            <span className="badge bg-primary-500 text-white mb-3 sm:mb-4 text-xs sm:text-sm">
              {post.category}
            </span>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 sm:py-4 border-y border-gray-200 dark:border-dark-700 mb-4 sm:mb-6 gap-3 sm:gap-0">
              <div className="flex items-center flex-wrap gap-x-3 gap-y-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                <span className="flex items-center space-x-1">
              ...
              <div className="flex items-center space-x-4 sm:space-x-3">
                <button
                  onClick={handleLike}
                  className={`flex items-center space-x-1 min-h-[44px] sm:min-h-0 ${
                    hasLiked ? 'text-red-500' : 'text-gray-600 dark:text-gray-400'
                  } hover:text-red-500 transition touch-manipulation`}
                >
                  <Heart size={20} fill={hasLiked ? 'currentColor' : 'none'} />
                ...
                <button
                  onClick={handleShare}
                  className="flex items-center space-x-1 text-gray-600 dark:text-gray-400 hover:text-primary-500 transition min-h-[44px] sm:min-h-0 touch-manipulation"
                >
                  <Share2 size={20} />
                </button>
              </div>
              ...
              <div className="mb-4 sm:mb-6">
                ...
                {post.videoLink && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center space-x-2 mt-3 sm:mt-4 text-primary-500 hover:text-primary-600 transition text-sm sm:text-base touch-manipulation min-h-[44px] sm:min-h-0"
                  >
                    <ExternalLink size={16} />
                    <span>Watch Full Video</span>
                  </a>
            ...
            {/* Content - Mobile-optimized prose */}
            <div 
            ...
            <div className="border-t border-gray-200 dark:border-dark-700 pt-4 sm:pt-6">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                <button className="btn-outline text-xs sm:text-sm min-h-[44px] sm:min-h-0 touch-manipulation">
                  Facebook
                </button>
                <button className="btn-outline text-xs sm:text-sm min-h-[44px] sm:min-h-0 touch-manipulation">
                  Twitter
                ...
                <button onClick={handleShare} className="btn-outline text-xs sm:text-sm min-h-[44px] sm:min-h-0 touch-manipulation">
                  Copy Link
                </button>
              </div>
            </div>
        ...
        {/* Sidebar - Hidden on mobile by default, show below content */}
        <div className="lg:col-span-1">
